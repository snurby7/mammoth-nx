...
import { IBudget, IBudgetQuery, IBudgetRequest, IBudgetUpdate } from '../common'
...
export class BudgetService {
   ...
   * @param {IBudgetRequest} request
   * @returns {Promise<IBudget>}
   * @memberof BudgetService
   */
  public createBudget(request: IBudgetRequest): Observable<IBudget> {
   ...
   * Budget label
   *
   * @param {IBudgetQuery} query
   * @returns {Observable<IBudget[]>}
   * @memberof BudgetService
   */
  public queryBudgets(query: IBudgetQuery): Observable<IBudget[]> {
   ...
   *
   * @param {UpdateBudgetDto} request
   * @returns {Observable<IBudget>}
   * @memberof BudgetService
   */
  public saveBudget(request: IBudgetUpdate): Observable<IBudget> {
