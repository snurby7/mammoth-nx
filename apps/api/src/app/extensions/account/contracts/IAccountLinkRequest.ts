...
import { IAccountBalanceRequest } from './IAccountBalanceRequest'

export interface IReferenceNodeMeta extends INeo4jCoreNode {
  /**
...
export interface IAccountLinkedNodeMeta extends INeo4jCoreNode {
  /**
